/*
	...
	@author SimeonC (Customised by Ryan Drake on behalf of OtherLevels Inc.)
	@license 2015 MIT
	@version 1.0.2
      ...
      controller: [
        '$scope', 'olDateTimeI18n', function(scope, olDateTimeI18n) {
          ...
          return scope.modeSwitchText = function() {
            return olDateTimeI18n.switchTo + ' ' + (scope._mode === 'date' ? olDateTimeI18n.clock : olDateTimeI18n.calendar);
          };
        }
      ]
    };
